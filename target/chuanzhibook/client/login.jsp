...
<title>电子书城</title>
	...
	<script type="text/javascript">
		window.onload = function () {
			var uname = "${cookie.username.value}";
			var pword = "${cookie.password.value}";
															...
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td style="text-align:left"><input name="username"
																		type="text" class="textinput" value="${cookie.username.value}"/>
																	</td>
																</tr>
																<tr>
																	<td style="text-align:right; padding-top:5px">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
																	<td style="text-align:left"><input name="password"
																		type="password" class="textinput" value="${cookie.password.value}"/>
																	</td>
																</tr>
																<tr>
																	<td colspan="2" style="text-align:center">
																		<input type="checkbox" name="remember" value="checkbox01" />记住用户名
																		&nbsp;&nbsp; 
																		<input type="checkbox" name="autologin" value="checkbox02" /> 自动登录
																	</td>
																</tr>
																<tr>
																	<td colspan="2"
